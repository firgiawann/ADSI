...
Folder ini berisi tiga diagram UML yang dibuat menggunakan **PlantUML** untuk mendokumentasikan arsitektur dan alur kerja sistem **ZEO** — sistem Point of Sale (POS) dan manajemen inventaris untuk sebuah kafe.
